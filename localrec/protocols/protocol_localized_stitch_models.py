...
class ProtLocalizedStitchModels(EMProtocol):
    ...
    def biologicalAssemblyStep(self):
        ...
        shiftInBiologicalAssembly = 0 # float((self.bigBox/2)*self.samplingRate)
        ...
        mmDict['_pdbx_struct_oper_list.vector[1]'] = [str(0) if i==0 else str(shiftInBiologicalAssembly) for i in range(len(symMatrices))]
        ...
        mmDict['_pdbx_struct_oper_list.vector[2]'] = [str(0) if i==0 else str(shiftInBiologicalAssembly) for i in range(len(symMatrices))]
        ...
        mmDict['_pdbx_struct_oper_list.vector[3]'] = [str(0) if i==0 else str(shiftInBiologicalAssembly) for i in range(len(symMatrices))]
