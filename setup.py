...
from os import path
from localrec import __version__
...
setup(
    ...
    description='Localrec ready to use in scipion.',  # Required
    ...
    keywords='localizedreconstruction cryoem imageprocessing scipion-3.0',  # Optional
    ...
    entry_points={
        'pyworkflow.plugin': 'localrec = localrec'
    }
)
